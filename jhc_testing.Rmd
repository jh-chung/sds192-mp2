...
cobn2 <- hcand_contributions %>%
  ...
  group_by(cand_party_affiliation , transaction_type , transaction_amt , cand_election_yr) 
```
...
#  group_by(cand_id , cand_election_yr , cand_party_affiliation , transaction_type) %>%
...
# Here, checking the Dems contributions. Gives us total spent against Dems, resulting in Ws, and total spent against 


ggplot(d_cobn , aes(x = cand_election_yr , y = transaction_amt)) +
  geom_point()
